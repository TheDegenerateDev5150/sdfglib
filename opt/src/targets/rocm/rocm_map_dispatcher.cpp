...
void ROCMMapDispatcher::dispatch_kernel_preamble(
    ...
    std::string indvar_x = "__daisy_hip_indvar_x";
    std::string indvar_y = "__daisy_hip_indvar_y";
    std::string indvar_z = "__daisy_hip_indvar_z";

    std::string thread_idx_x = "__daisy_hip_thread_idx_x";
    std::string thread_idx_y = "__daisy_hip_thread_idx_y";
    std::string thread_idx_z = "__daisy_hip_thread_idx_z";
