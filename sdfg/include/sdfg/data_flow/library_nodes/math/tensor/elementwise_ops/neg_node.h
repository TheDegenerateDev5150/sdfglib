...
inline data_flow::LibraryNodeCode LibraryNodeType_Neg("ml::Neg");

class NegNode : public ElementWiseDataflowTensorNode {
public:
    NegNode(
        size_t element_id,
...
typedef SimpleElementWiseDataflowTensorNodeSerializer<NegNode> NegNodeSerializer;
